    ...
    const llenarFormulario = async () => {
      try {
        ...
        if (typeof location.state != "undefined") {
          if (location.state.idrol) {
            tempRol = location.state.idrol;
          }
        }
        ...
        const response = await axios.get(
          process.env.REACT_APP_API_URL + "/rol/" + tempRol + "/",
          {
            headers: {
              Authorization: "Bearer " + serviceAAD.getToken(),
            },
        ...
        setIdRol(dataR.idrol);


        setValue("nombre_rol",dataR.nombre_rol);
        setValue("descripcion_rol",dataR.descripcion_rol);
        setValue("poblacion",dataR.poblacion);
